...
export type AppEvent = {
  // demanda_atribuida não vira toast: o modal de confirmação é quem escuta.
  kind: "project_created" | "task_created" | "solicitacao_cadastro" | "nota_compartilhada" | "demanda_atribuida";
  workspaceId?: string;
  actorId?: string;
